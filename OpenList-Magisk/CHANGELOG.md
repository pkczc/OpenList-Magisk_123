...
##### 2025/10/9 02: 07
##### 试了一下openlist解除123盘限制那个第三方魔改二进制，还是一样限制。它也不提示限制1G流量，它是直接转圈圈不提示，文件下载链接也没能打开查看。用多线程下载器下载报错403。所以还是用openlist官方二进制好了。「https://github.com/Yxiguan/OpenList_123/」，第三方不开源的魔改版也不知道里面藏了有什么东西。如果你们觉得好奇可以进这个仓库下载替换进去玩玩。
